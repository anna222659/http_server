...
import httpx
async def call(request, raw_request: Request):
    try:
        # Extract data from the parsed request object
        request_data = {
        ...
        # Extract raw request information
        raw_request_data = {
        ...
        payload = {
            ...
            "body": await raw_request.body()  # Get raw body if needed
        }
